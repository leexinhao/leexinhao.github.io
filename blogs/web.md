...
```yaml
title: Xinhao Li
url: https://leexinhao.github.io

owner: 
  name: Xinhao Li
  avatar: xinhao.jpg (根目录下的图片)
...
现在，聪明的你可能又发现了，在笔者的站点中，点击[Here is my Resume](https://leexinhao.github.io/file/Resume-HanlinCAI.pdf)，就可以访问笔者的个人简历。也就是说，你只需要甩给别人一个链接，就可以实时访问你的最新简历，而不用重复发送最新版简历，这真是太方便了！
...
```markdown
[Here is my Resume](https://leexinhao.github.io/file/Resume-HanlinCAI.pdf)
[] 里面放置你想显示的内容文本
() 紧跟着，放置文件的绝对地址
```
